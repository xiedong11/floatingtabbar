...
import com.zhuandian.floatingtabbar.tabview.TabBarView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int [] fragmentColors= {Color.RED,Color.YELLOW,Color.WHITE,Color.BLACK,Color.BLUE};
...
//            imageView.setImageDrawable(drawable[position]);
            ...
            getFragmentManager()
                    .beginTransaction()
                    .replace(R.id.container, new FragmentPage().getInstance(fragmentColors[position]))
                    .commit();
